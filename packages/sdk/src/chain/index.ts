/**
 * Full chain-layer barrel — the `stellar-confidential-sdk/chain` subpath surface (see
 * `src/chain.ts`).
 *
 ...
 * `stellar-confidential-sdk` barrel without clashing. Resolution: the top-level barrel keeps
 * the state-engine surface and re-exports ONLY `payload.js` from here; the chain
 * reader / events / auditor decrypt live on `stellar-confidential-sdk/chain` instead.
 */
