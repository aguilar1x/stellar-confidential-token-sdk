/**
 * Browser-safe public barrel for `stellar-confidential-sdk`. This entry MUST NOT import any
 ...
 * `stellar-confidential-sdk/node` subpath ({@link ./node.ts}) instead.
 */
...
// chain reader / events / auditor decrypt live on the `stellar-confidential-sdk/chain`
