...
try {
...

  {
    ...
    blocks: [
      {
        kind: "p",
        text: "Proofs are generated by bb.js compiled to WASM, which wants threads, which wants SharedArrayBuffer, which wants cross-origin isolation. Verification needs none of this — it is field arithmetic — so a page that only checks balances can skip the headers entirely.",
      },
      {
        kind: "code",
        lang: "ts",
